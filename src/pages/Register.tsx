            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        ¿Ya tienes cuenta? <Link to="/login" className="font-medium text-urbania-primary hover:text-urbania-secondary">Inicia sesión</Link>
                    </p>
                </div>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-urbania-primary focus:border-urbania-primary focus:z-10 sm:text-sm"
